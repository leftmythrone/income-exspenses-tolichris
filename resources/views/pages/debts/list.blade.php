...
<div class="tabcategory">
    ...
    <div class="tabtable">    
        <table width="100%">
            ...
            @if ( $debts[$listloop]->id === null )
            
            {{-- TABLE LIST CONTENT --}}
            @else
            <tr>
                <td><center> {{ $listloop + 1 }}. </center></td>
                <td><center>{{ $debts[$listloop]->debt_description }}</center></td>
                <td><center>{{ $debts[$listloop]->debcat_name }}</center></td>
                <td><center>{{ $debts[$listloop]->account_name }}</center></td>
                <td><center>Rp. {{ number_format($debts[$listloop]->debt_nominal, 0, " ,","."); }},00</center></td>
                <td><center>{{ $debts[$listloop]->debt_entry_date }}</center></td>
                <td>
                    <center>
                        <a href="/debt/viewlist/{{ $debts[$listloop]->debt_slug }}"><button><img src="/img/eye_white.png" alt=""></button></a>
                        <a href="/debt/editstore/{{ $debts[$listloop]->debt_slug }}"><button><img src="/img/pencil_white.png" alt=""></button></a> 
                        <a href="/debt/deletelistlanding/{{ $debts[$listloop]->debt_slug }}"><button><img src="/img/trash_white.png" alt=""></button></a>
                    </center>
                </td>
                <td>
                    <center>
                        <a href="/debt/paidlanding/{{ $debts[$listloop]->debt_slug }}"><button><img src="/img/paid_white.png" alt=""></button></a>
                    </center>
                </td>
            </tr>            
                ...
                <td>
                    <center>
                        <div class="entriesctrl">
                            <ul>
                                <li>
                                    <form action="/debt/entries/{{ $entdata }}" method="get">
